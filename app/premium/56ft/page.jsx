...
import {    ft56m1,
  ...
  ft56m5,
  ft56m6,
  ft56m7,} from '@/app/assets'
import WhatsLink from '@/app/components/WhatsLink'
const page = () => {
  return (
    <div className='yacht-page'>
        <Header/>
        <LandingYachtPage categoryName="premium" category="Premium" yachtName="56ft Majesty" 
       images={[ ft56m1, ft56m2, ft56m3,ft56m4,  ft56m5, ft56m6,ft56m7,]}/>
        <YachtDetails brand="Majesty" size="56ft" 
        feat1="Soft drinks, water, ice"
         ...
         feat5="E-Grill Equipment (upon request)" 
         />
        <Heading/>
        <YachtForm/>
         <Heading2/>
